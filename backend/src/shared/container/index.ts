...
import InfluenceActionsRepository from '@modules/influences/infra/typeorm/repositories/InfluenceActionsRepository';
...
container.registerSingleton<IInfluenceActionsRepository>(
  'InfluenceActionsRepository',
  InfluenceActionsRepository,
);
